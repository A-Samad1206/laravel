...
<div class="row">
    ...
    <form class="border bg-light p-4 shadow" action="{{ route("category.update","$cat->id") }}" method="POST">
        @csrf
        @method("PUT")
        <div class="form-group">
            <label for="">Edit Category</label>
            <input type="text" placeholder="{{ $cat->name }}" class="form-control form-control-sm" name="name">
